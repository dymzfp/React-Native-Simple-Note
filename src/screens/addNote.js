...
class AddNote extends React.Component {
  constructor(props) {
    ...
    let category = this.props.categories.data[0]._id;
    ...
    return (
        <Container>
                <Header style={{ backgroundColor: "white", marginBottom: 5 }}>
                    ...
                    <Right>
                        <TouchableOpacity onPress={() => this.addNotes({title:this.state.title, note:this.state.note, category:this.state.selectedCategory})}>
                          <Image
